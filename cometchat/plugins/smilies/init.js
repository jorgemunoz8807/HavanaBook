	...
	$.ccsmilies = (function () {
        ...
        return {
			...
			init: function (id) {
				...
				loadCCPopup(baseUrl+'plugins/smilies/index.php?id='+id+'&basedata='+baseData, 'smilies',"status=0,toolbar=0,menubar=0,directories=0,resizable=0,location=0,status=0,scrollbars=0, width=<?php echo $smlWidth;?>,height=<?php echo $smlHeight;?>",width,height-50,'<?php echo $smilies_language[1];?>'); 
			},
