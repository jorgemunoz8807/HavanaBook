	...
	$.ccscreenshare = (function () {
        ...
        return {
			...
			accept: function (id,random) {
				...
				loadCCPopup(baseUrl+'plugins/screenshare/index.php?action=screenshare&type=0&id='+random+'&basedata='+baseData, 'screenshare',"status=0,toolbar=0,menubar=0,directories=0,resizable=1,location=0,status=0,scrollbars=0, width=<?php echo $scrWidth;?>,height=<?php echo $scrHeight;?>",width,height,'<?php echo $screenshare_language[7];?>'); 
			}
        };
    })();
