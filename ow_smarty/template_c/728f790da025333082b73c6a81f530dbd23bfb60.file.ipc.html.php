<?php /* Smarty version Smarty-3.1.12, created on 2014-12-14 19:34:16
         compiled from "C:\xampp\htdocs\havanabook\ow_system_plugins\base\decorators\ipc.html" */ ?>
<?php /*%%SmartyHeaderCode:6711548e56b81a3676-37632606%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '728f790da025333082b73c6a81f530dbd23bfb60' => 
    array (
      0 => 'C:\\xampp\\htdocs\\havanabook\\ow_system_plugins\\base\\decorators\\ipc.html',
      1 => 1416959674,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6711548e56b81a3676-37632606',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_548e56b8275316_37775997',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_548e56b8275316_37775997')) {function content_548e56b8275316_37775997($_smarty_tpl) {?><?php if (!is_callable('smarty_block_style')) include 'C:\\xampp\\htdocs\\havanabook\\ow_smarty\\plugin\\block.style.php';
...
<div class="ow_ipc <?php if (!empty($_smarty_tpl->tpl_vars['data']->value['addClass'])){?><?php echo $_smarty_tpl->tpl_vars['data']->value['addClass'];?>
<?php }?> clearfix">
...
?>
                <?php if (!$_smarty_tpl->getVariable('smarty')->value['foreach']['toolbar']['first']&&(empty($_smarty_tpl->tpl_vars['item']->value['class'])||(!strstr($_smarty_tpl->tpl_vars['item']->value['class'],'ow_ipc_date')))){?> <span class="ow_delimiter">&middot;</span> <?php }?>
